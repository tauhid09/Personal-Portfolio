...
function Hero() {
    ...
    return (
        <>
            ...
            <section className="w-full min-h-screen flex flex-col items-center justify-center pt-4 bg bg-hero relative overflow-hidden" >
                ...
                <div className="absolute w-25 h-full left-0 flex flex-col items-center justify-center divHidden backdrop-blur-3xl">
                    <div className="h-105 w-15 flex flex-col justify-around items-center gap-5">
                ...
                <div className='relative min-[769px]:hidden h-[500px] w-full mb-10'>
                ...
                <div className='max-[769px]:w-full  w-[500px] h-[250px]  max-[769px]:flex-col z-20 intro'>
                    <p className='max-[769px]:relative h-[150px] flex justify-center text-[14px] items-center p-5 text-white max-[769px]:bg-black/60 rounded-3xl max-[769px]:text-center uppercase intro-p' >I am a Salesforce Developer and Frontend Developer who enjoys building user-friendly interfaces, scalable applications, and continuously improving in cloud and web technologies.</p>
                </div>
            </section>
        </>
    )
